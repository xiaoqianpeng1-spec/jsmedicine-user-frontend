...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "D:/work/jsmedicine-user-frontend/node_modules/ufo/dist/index.mjs";
...
import { u as useHead } from "./v3-QFCvAakx.js";
...
import "D:/work/jsmedicine-user-frontend/node_modules/@unhead/vue/dist/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-d1be27aa><div class="fixed left-0 right-0 spotlight z-10" data-v-d1be27aa></div><div class="max-w-520px text-center z-20" data-v-d1be27aa><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-d1be27aa>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-d1be27aa>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-d1be27aa>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d1be27aa"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-DvP-hXi_.js.map
