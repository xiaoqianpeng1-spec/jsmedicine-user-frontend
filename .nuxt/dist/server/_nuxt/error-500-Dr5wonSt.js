...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-0e3664cd><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-0e3664cd></div><div class="max-w-520px text-center" data-v-0e3664cd><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-0e3664cd>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-0e3664cd>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0e3664cd"]]);
export {
  error500 as default
};
//# sourceMappingURL=error-500-Dr5wonSt.js.map
