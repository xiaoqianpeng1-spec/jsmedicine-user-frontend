...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "exam-detail-page" }, _attrs))} data-v-c693d023><section class="page-banner" data-v-c693d023><div class="container" data-v-c693d023><div class="banner-content" data-v-c693d023><h1 class="banner-title" data-v-c693d023>${ssrInterpolate(examPaper.value.paperName)}</h1><p class="banner-desc" data-v-c693d023>${ssrInterpolate(examPaper.value.description)}</p><div class="exam-info" data-v-c693d023><span class="info-item" data-v-c693d023>📝 ${ssrInterpolate(examPaper.value.questions.length)} 题</span><span class="info-item" data-v-c693d023>⏱️ ${ssrInterpolate(examPaper.value.durationMinutes)} 分钟</span><span class="info-item" data-v-c693d023>🏆 满分 ${ssrInterpolate(examPaper.value.totalScore)} 分</span><span class="info-item" data-v-c693d023>✅ 及格线 ${ssrInterpolate(examPaper.value.passScore)} 分</span></div></div></div></section><div class="breadcrumb-section" data-v-c693d023><div class="container" data-v-c693d023><div class="breadcrumb" data-v-c693d023><span class="breadcrumb-item" data-v-c693d023>首页</span><span class="breadcrumb-separator" data-v-c693d023>&gt;</span><span class="breadcrumb-item" data-v-c693d023>考核</span><span class="breadcrumb-separator" data-v-c693d023>&gt;</span><span class="breadcrumb-item active" data-v-c693d023>${ssrInterpolate(examPaper.value.paperName)}</span></div></div></div>`);
      if (!submitted.value) {
...
//# sourceMappingURL=_id_-BqNhPFqp.js.map
