import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { ref, hasInjectionContext, inject, toRaw, computed, isRef, isReactive, toRef, getCurrentInstance, reactive, effectScope, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, mergeProps, isReadonly, isShallow } from 'vue';
import { v as klona, x as parseURL, h as encodePath, d as decodePath, q as hasProtocol, s as isScriptProtocol, u as joinURL, F as withQuery, m as getRequestHeader, g as destr, r as isEqual, y as sanitizeStatusCode, j as getContext, z as setCookie, k as getCookie, f as deleteCookie, $ as $fetch, e as defu, a as createHooks, c as createError$1, i as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "home",
    path: "/home",
    component: () => import('./home-9raCNX-k.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BzgFwKK0.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-GMFljAaL.mjs')
  },
  {
    name: "exam-id",
    path: "/exam/:id()",
    component: () => import('./_id_-D5_MmX5S.mjs')
  },
  {
    name: "audio-id",
    path: "/audio/:id()",
    component: () => import('./_id_-CY_gwM8R.mjs')
  },
  {
    name: "books-id",
    path: "/books/:id()",
    component: () => import('./_id_-0v6Uuv01.mjs'),
    children: [
      {
        name: "books-id-chapter-chapterId",
        path: "chapter/:chapterId()",
        component: () => import('./_chapterId_-CWDwI79N.mjs')
      }
    ]
  },
  {
    name: "exam",
    path: "/exam",
    component: () => import('./index-BcidU3h6.mjs')
  },
  {
    name: "video-id",
    path: "/video/:id()",
    component: () => import('./_id_-CSjf5K9h.mjs')
  },
  {
    name: "audio",
    path: "/audio",
    component: () => import('./index-CFDiWAGd.mjs')
  },
  {
    name: "books",
    path: "/books",
    component: () => import('./index-RDrLXq2K.mjs')
  },
  {
    name: "detail-id",
    path: "/detail/:id()",
    component: () => import('./_id_-DfBOLGMr.mjs')
  },
  {
    name: "topics-id",
    path: "/topics/:id()",
    component: () => import('./_id_-BCWk9HF9.mjs'),
    children: [
      {
        name: "topics-id-sections-sectionType",
        path: "sections/:sectionType()",
        component: () => import('./_sectionType_-m9JpKd7j.mjs')
      }
    ]
  },
  {
    name: "video",
    path: "/video",
    component: () => import('./index-DrAlPidw.mjs')
  },
  {
    name: "consult-id",
    path: "/consult/:id()",
    component: () => import('./_id_-C-fpCKhc.mjs'),
    children: [
      {
        name: "consult-id-qa-qaId",
        path: "qa/:qaId()",
        component: () => import('./_qaId_-CnHYJh1s.mjs')
      }
    ]
  },
  {
    name: "exam-records",
    path: "/exam/records",
    component: () => import('./records-r_XXELAO.mjs'),
    children: [
      {
        name: "exam-records-id",
        path: ":id()",
        component: () => import('./_id_-LImTj5QI.mjs')
      }
    ]
  },
  {
    name: "topics-covid",
    path: "/topics/covid",
    component: () => import('./covid-DzdhvV9R.mjs')
  },
  {
    name: "topics",
    path: "/topics",
    component: () => import('./index-CS5A-0z7.mjs')
  },
  {
    name: "certify",
    path: "/certify",
    component: () => import('./index-BiHHziWV.mjs')
  },
  {
    name: "consult",
    path: "/consult",
    component: () => import('./index-CgtPFPRr.mjs')
  },
  {
    name: "articles",
    path: "/articles",
    component: () => import('./index-CSxvMH84.mjs')
  },
  {
    name: "favorites",
    path: "/favorites",
    component: () => import('./index-Dslw1Gaa.mjs')
  },
  {
    name: "knowledge",
    path: "/knowledge",
    component: () => import('./index-Cdl2RFMV.mjs')
  },
  {
    name: "articles-detail-id",
    path: "/articles/detail/:id()",
    component: () => import('./_id_-CJ1Cc9ia.mjs')
  },
  {
    name: "knowledge-detail-id",
    path: "/knowledge/detail/:id()",
    component: () => import('./_id_-BXk8G7hw.mjs')
  }
];
...
const authApi = {
  ...
  async updateUserInfo(token, userData) {
    return useApi("/api/v1/app/profile", {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`
  ...
  async checkAvatar(token, fileName, fileSize, fileMd5) {
  ...
  async getCertificateList(token) {
  ...
  async submitCertificate(token, certificateData) {
  ...
  async getCertificateDetail(token, certificateId) {
  ...
  async applyCertificate(token, certificateData) {
...
const profileApi = {
  ...
  // 申请头像上传地址
  async applyAvatarUploadUrl(request) {
  ...
  // 确认头像上传
  async confirmAvatarUpload(request) {
  ...
  // 查询我的收藏
  async getFavorites(page, size, sort) {
  ...
  // 查询浏览记录
  async getBrowseHistories(page, size, sort) {
    const params = new URLSearchParams();
    params.set("page", page.toString());
    params.set("size", size.toString());
    if (sort) {
  ...
  // 提交学员认证申请
  async submitCertification(request) {
    return useApi("/api/v1/app/profile/certification", {
      method: "POST",
      body: request
    });
...
const api_jy9dy79pM_nYQuRKPrcfNg56p_gKkzw9SekUTZgAenc = /* @__PURE__ */ defineNuxtPlugin(() => {
  ...
  api.interceptors.request.use(
    (config2) => {
      if (userStore.token) {
        config2.headers.Authorization = `Bearer ${userStore.token}`;
      }
      return config2;
    },
    (error) => {
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-Cp--sye0.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-zGYAmuoc.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B8r-ZVnk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DvXRS3Nw.mjs'));
...
export { nuxtLinkDefaults as a, useCookie as b, useNuxtApp as c, defineNuxtRouteMiddleware as d, entry_default as default, encodeRoutePath as e, useRoute as f, useRouter as g, useRuntimeConfig as h, useUserStore as i, navigateTo as n, profileApi as p, resolveRouteObject as r, storeToRefs as s, tryUseNuxtApp as t, useApi as u };
