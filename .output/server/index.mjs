...
import { B as toNodeListener, g as destr, E as useRuntimeConfig, C as trapUnhandledNodeErrors, A as setupGracefulShutdown, D as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
